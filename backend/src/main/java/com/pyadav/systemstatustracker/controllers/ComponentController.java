...
public class ComponentController {
    ...
    public ResponseEntity<String> updateComponent(@PathVariable("userId") String userId, @PathVariable("systemId") String systemId, @RequestBody ComponentModel component) {
        return componentService.updateComponent(userId, systemId, component);
    }
